    ...
    enum ChannelState {
        ...
        ACTIVE(true) {
            ...
            void processOFMessage(final SwitchChannelHandler h,
                ...
                System.out.println("processOFMessage: OFMessage summary: " + m.toString());
                switch (m.getType()) {
                case ECHO_REQUEST:
                ...
                case PACKET_IN:
                    System.out.println("processOFMessage: Matched with PACKET_IN");
                case PORT_STATUS:
                case QUEUE_GET_CONFIG_REPLY:
                case STATS_REPLY:
                case VENDOR:
                    System.out.println("processOFMessage: Matched with VENDOR");
                    if (h==null)
                        System.out.println("SwitchChannelHandler is null");
                    else if(h.sw == null)
                        System.out.println("h.sw is null");
                    else if(h.channel == null)
                        System.out.println("h.channel is null");
                    else
                ...
                case FLOW_MOD:
                    System.out.println("processOFMessage: FLOW_MOD");
                    this.illegalMessageReceived(h, m);
                    break;
                default:
                    break;
                }
                System.out.println("Going alive from processOFMessage");
    ...
    public void messageReceived(final ChannelHandlerContext ctx,
        ...
        if (e.getMessage() instanceof List) {
            ...
            for (final OFMessage ofm : msglist) {
                ...
                System.out.println("messageReceived: OFMessage summary: " + ofm.toString());
                ...
                try {
                    ...
                    // ctx.getChannel().
                    System.out.println("Caught exception. Going to fire exceptionCaught");
