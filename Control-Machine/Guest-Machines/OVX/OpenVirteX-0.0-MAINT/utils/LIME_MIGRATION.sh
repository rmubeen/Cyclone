...
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm11", "priority":"100", "eth_type":"2048", "ingress-port":"3", "dst-ip": "10.10.3.10", "active": "true", "actions": "output=2"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
...
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm21", "priority":"100", "eth_type":"2048", "ingress-port":"3", "dst-ip": "10.10.3.20", "active": "true", "actions": "output=3"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
...
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm31", "priority":"100", "eth_type":"2048", "ingress-port":"3", "dst-ip": "10.10.3.30", "active": "true", "actions": "output=4"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm32", "priority":"100", "eth_type":"2048", "ingress-port":"4", "dst-ip": "10.10.3.30", "active": "true", "actions": "output=4"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
...
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm51", "priority":"100", "eth_type":"2048", "ingress-port":"3", "dst-ip": "10.10.3.50", "active": "true", "actions": "output=5"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm52", "priority":"100", "eth_type":"2048", "ingress-port":"4", "dst-ip": "10.10.3.50", "active": "true", "actions": "output=5"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
curl -d '{"switch": "00:a4:23:05:00:00:00:01", "name":"vm53", "priority":"100", "eth_type":"2048", "ingress-port":"5", "dst-ip": "10.10.3.50", "active": "true", "actions": "output=5"}' http://10.10.10.7:8080/wm/staticflowentrypusher/json
...
python ovxctl.py -n connectHost 1 00:a4:23:05:00:00:00:02 5 $int_5_mac
