...
public class FVError extends org.openflow.protocol.OFError implements
	...
	public void classifyFromSwitch(WorkerSwitch workerSwitch) {
		...
		// System.out.println("NOFEL: Printing Trace: ");
		// for (StackTraceElement e : stackTraceElement) {
			// System.out.println(e.toString());	
		// }
		// System.out.println("End of Stack");
		// System.out.println("NOFEL Printing Switch Data\n" + workerSwitch.printWorkerSwitch());
		...
		if (fvSlicer == null) {
			System.out.println("NOFEL FVError: Unknown xID");
		...
		if (this.errorType == (short) OFErrorType.OFPET_BAD_ACTION.ordinal() 
			...
			System.out.println("NOFEL FVError: Flow mod failed or bad action");
			fvSlicer.decrementFlowRules();
		}
		System.out.println("NOFEL: Error occured only if reason specified after switch dpid");
