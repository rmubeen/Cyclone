...
public class LimeVMMigrater {
	private static final String URI_STRING = "qemu+ssh://root@";
	...
	public static boolean liveMigrateQemuVM(String sourceIP, String destIP, String vmDomain){
		...
		try {
			if(domain_to_migrate.isActive() == 1){
				System.out.println("SAIM -- Bandwidth Set to 10 Gbps -- Hardcoded");
				Domain migrated_domain = domain_to_migrate.migrate(dst, 1, null, null, 10000);
