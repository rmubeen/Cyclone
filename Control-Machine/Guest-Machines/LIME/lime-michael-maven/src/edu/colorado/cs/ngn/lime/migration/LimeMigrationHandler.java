...
//			destMac = LimeMigrationUtils.getMacForPort(new DPID(receiverSwitchObject.getDPID()), vlanNumber, LimeContainer.getDpidToMacMap());
	...
	private Map<FVFlowMod, List<FVFlowMod>> createAndSendVlanMigrationPairsMod(short ghostPort, FVFlowMod originalMod, WorkerSwitch senderSwitchObject, boolean originalToClone, boolean preMigration, short preMigrationPort) throws SwitchOriginalAndCloneException, LimeDummyPortNotFoundException, DPIDLookupException {
		...
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 1");
		...
		for(OFAction action : clonedMod.getActions()){
			// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 2");
			if(action instanceof OFActionOutput){
				// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 3");
				short currentOutputPort = ((OFActionOutput) action).getPort();
				try {
					// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 4");
					...
					if(outputToLocalPort){
						// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 5");
						localPortsActions.add((OFActionOutput) action);
					}
					// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 6");
					if(outputToRemotePort){
						// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 7");
						remotePortsActions.add((OFActionOutput) action);
						remoteOutputPorts.add(((OFActionOutput) action).getPort());
					}
					// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 8");
					if(!outputToLocalPort && !outputToRemotePort){
						// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 9");
						unneededActions.add((OFActionOutput) action);
					}
					// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 10");
				} catch (DPIDLookupException e) {
					// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 11");
					//this shouldn't happen. If it does, return null
					return null;
				}
				// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 12");
			}
			// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 13");
		}
		
		//get rid of all unneeded actions
		clonedMod.getActions().removeAll(unneededActions);
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 14");
		for(OFActionOutput migratedAction : remotePortsActions){
			// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 15");
			...
			if(localPortsActions.contains(migratedAction)){
				// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 16");
			...
			// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 17");
		...
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 18");
		clonedMod.computeLength();
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 18.1");
		System.out.println("Flow after modification: "+clonedMod);
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 18.2");
		LimeMigrationUtils.sendFlowMod(clonedMod, senderSwitchObject);
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 18.3");
		
		HashMap<FVFlowMod, List<FVFlowMod>> modMap = new HashMap<FVFlowMod, List<FVFlowMod>>();
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 18.4");
		ArrayList<FVFlowMod> receiverMods = new ArrayList<FVFlowMod>();
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 18.5");
		...
		for(Short remotePort : remoteOutputPorts){
			// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 19");
		...
		// System.out.println("NOFEL createAndSendVlanMigrationPairsMod Line 20");
